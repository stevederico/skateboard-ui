...
export declare const Toggle: {
	<Value extends string>(props: Toggle.Props<Value> & React$1.RefAttributes<HTMLButtonElement>): React$1.JSX.Element;
};
...
export type ToggleChangeEventReason = typeof none;
