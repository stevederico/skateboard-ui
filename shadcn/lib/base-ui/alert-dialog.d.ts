...
interface DialogCloseProps extends NativeButtonProps, BaseUIComponentProps<"button", DialogCloseState> {
}
...
declare const DialogPortal: React$1.ForwardRefExoticComponent<Omit<DialogPortalProps, "ref"> & React$1.RefAttributes<HTMLDivElement>>;
...
declare const DialogViewport: React$1.ForwardRefExoticComponent<Omit<DialogViewportProps, "ref"> & React$1.RefAttributes<HTMLDivElement>>;
...
interface DialogViewportProps extends BaseUIComponentProps<"div", DialogViewportState> {
}
...
declare function DialogRoot<Payload>(props: DialogRoot.Props<Payload>): import("react/jsx-runtime").React$1.JSX.Element;
 ...
 */
export declare function AlertDialogRoot<Payload>(props: AlertDialogRoot.Props<Payload>): import("react/jsx-runtime").React$1.JSX.Element;
...
export interface AlertDialogTrigger {
	<Payload>(componentProps: AlertDialogTriggerProps<Payload>): React$1.JSX.Element;
}
...
declare namespace AlertDialog {
	export { AlertDialogHandle as Handle, AlertDialogRoot as Root, AlertDialogTrigger as Trigger, DialogBackdrop as Backdrop, DialogClose as Close, DialogDescription as Description, DialogPopup as Popup, DialogPortal as Portal, DialogTitle as Title, DialogViewport as Viewport, createAlertDialogHandle as createHandle };
}
